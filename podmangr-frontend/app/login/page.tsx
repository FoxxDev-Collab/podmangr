    ...
    try {
      ...
      if (success) {
        toast.success("Authentication successful", {
          description: "Welcome to Podmangr.",
        });
        router.push("/container-manager");
      } else {
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-6">
            <div className="relative">
              {/* Outer ring */}
              <div className="w-24 h-24 border-2 border-accent rounded-lg flex items-center justify-center shadow-[0_0_30px_rgba(112,187,179,0.4)]">
                <Lock className="w-12 h-12 text-accent drop-shadow-[0_0_10px_rgba(112,187,179,0.8)]" />
              </div>
              {/* Glow effect */}
          ...
          <h1 className="text-4xl font-bold tracking-wide text-foreground mb-2 drop-shadow-[0_0_20px_rgba(112,187,179,0.3)]">
            Podmangr
          </h1>
          <p className="text-sm text-muted-foreground tracking-wide font-medium">
            Podman deserves better tooling.
          </p>
