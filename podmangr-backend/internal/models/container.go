...
// Container represents a managed container in Podmangr
type Container struct {
	...
	Metadata     string          `json:"metadata"`             // JSON Podmangr-specific data
}
...
type CreateContainerRequest struct {
	...
	PodID        string            `json:"pod_id,omitempty"`        // Pod to add container to
...
// AdoptContainerRequest represents a request to adopt an existing container into Podmangr
...
type UpdateContainerImageRequest struct {
	...
	BackupPath      string `json:"backup_path,omitempty"`      // Where to store backup (default: ~/.podmangr/backups)
