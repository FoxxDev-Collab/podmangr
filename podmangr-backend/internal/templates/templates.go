...
// CryptPadTemplate is the CryptPad encrypted office suite template
var CryptPadTemplate = BuiltInTemplate{
	ID:          "cryptpad-office",
	Name:        "CryptPad Office",
	Description: "End-to-end encrypted office suite with documents, spreadsheets, presentations, kanban boards, and more.",
	Category:    "office",
	Icon:        "file-text",
...
services:
  cryptpad:
    ...
    container_name: cryptpad-office
    hostname: cryptpad
    environment:
    ...
    labels:
      - "podmangr.app=office"
      - "podmangr.name=CryptPad Office"
      - "podmangr.icon=file-text"
      - "podmangr.webui=true"
      - "podmangr.webui.port=3000"
...
`,
	...
	VolumePaths: map[string]string{
		"cryptpad_blob":      "/var/lib/podmangr/office/blob",
		"cryptpad_block":     "/var/lib/podmangr/office/block",
		"cryptpad_data":      "/var/lib/podmangr/office/data",
		"cryptpad_datastore": "/var/lib/podmangr/office/datastore",
		"cryptpad_config":    "/var/lib/podmangr/office/config",
	},
	WebUI: &WebUIConfig{
		Port:     3000,
		Path:     "/",
...
services:
  ...
  server:
    ...
    restart: unless-stopped
    labels:
      - "podmangr.app=authentik"
      - "podmangr.name=Authentik"
      - "podmangr.icon=shield-check"
      - "podmangr.webui=true"
      - "podmangr.webui.port=9000"
...
`,
	...
	VolumePaths: map[string]string{
		"authentik_db":        "/var/lib/podmangr/authentik/db",
		"authentik_redis":     "/var/lib/podmangr/authentik/redis",
		"authentik_media":     "/var/lib/podmangr/authentik/media",
		"authentik_templates": "/var/lib/podmangr/authentik/templates",
		"authentik_certs":     "/var/lib/podmangr/authentik/certs",
	},
	WebUI: &WebUIConfig{
		Port:     9000,
		Path:     "/",
